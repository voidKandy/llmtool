...
export class Model {
    ...
    get_embeddings(input) {
        const ret = wasm.model_get_embeddings(this.__wbg_ptr, input);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_80c94b23c6d868ca = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('model_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
